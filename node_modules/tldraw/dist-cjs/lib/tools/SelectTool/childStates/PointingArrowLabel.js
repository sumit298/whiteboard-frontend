...
class PointingArrowLabel extends import_editor.StateNode {
  ...
  onPointerMove() {
    ...
    const geometry = import_arrowLabel.arrowBodyGeometryCache.get(this.editor, shape.id);
    ...
    let nextLabelPosition = import_arrowLabel.arrowBodyGeometryCache.get(this.editor, shape.id).uninterpolateAlongEdge(pointInShapeSpace);
