...
var require_species_constructor = __commonJS({
  "node_modules/core-js/internals/species-constructor.js"(exports, module) {
    ...
    module.exports = function(O2, defaultConstructor) {
      var C = anObject4(O2).constructor;
      var S;
      return C === void 0 || isNullOrUndefined(S = anObject4(C)[SPECIES]) ? defaultConstructor : aConstructor(S);
    };
  }
});
...
var require_task = __commonJS({
  "node_modules/core-js/internals/task.js"(exports, module) {
    ...
    var Function = globalThis2.Function;
    ...
    if (!set || !clear) {
      ...
      } else if (globalThis2.addEventListener && isCallable(globalThis2.postMessage) && !globalThis2.importScripts && $location && $location.protocol !== "file:" && !fails3(globalPostMessageDefer)) {
...
var require_safe_get_built_in = __commonJS({
  "node_modules/core-js/internals/safe-get-built-in.js"(exports, module) {
    ...
    module.exports = function(name) {
      ...
      var descriptor = getOwnPropertyDescriptor3(globalThis2, name);
...
var require_es_promise_constructor = __commonJS({
  "node_modules/core-js/modules/es.promise.constructor.js"() {
    ...
    var onUnhandled = function(state) {
      call3(task, globalThis2, function() {
...
var require_iterators_core = __commonJS({
  "node_modules/core-js/internals/iterators-core.js"(exports, module) {
    ...
    var NEW_ITERATOR_PROTOTYPE = !isObject3(IteratorPrototype) || fails3(function() {
      var test2 = {};
...
$3({ target: "String", proto: true, forced: !MDN_POLYFILL_BUG2 && !CORRECT_IS_REGEXP_LOGIC2 }, {
  endsWith: function endsWith(searchString) {
    ...
    var len = that.length;
    var end = endPosition === void 0 ? len : min2(toLength3(endPosition), len);
...
fixRegExpWellKnownSymbolLogic2("split", function(SPLIT, nativeSplit, maybeCallNative) {
  ...
  return [
    ...
    function split(separator, limit) {
      var O2 = requireObjectCoercible4(this);
      var splitter = isObject2(separator) ? getMethod2(separator, SPLIT) : void 0;
      return splitter ? call2(splitter, separator, O2, limit) : call2(internalSplit, toString4(O2), separator, limit);
    },
    ...
    function(string, limit) {
      ...
      if (lim === 0)
        return [];
      if (S.length === 0)
        return regExpExec2(splitter, S) === null ? [S] : [];
      var p2 = 0;
      var q = 0;
      var A = [];
      while (q < S.length) {
        splitter.lastIndex = UNSUPPORTED_Y ? 0 : q;
        var z = regExpExec2(splitter, UNSUPPORTED_Y ? stringSlice2(S, q) : S);
        var e2;
        if (z === null || (e2 = min3(toLength4(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)), S.length)) === p2) {
...
$6({ target: "String", proto: true, forced: !correctIsRegExpLogic3("includes") }, {
  includes: function includes(searchString) {
    return !!~stringIndexOf(
      ...
      toString5(notARegExp3(searchString)),
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-6LMLNOFT.js.map
